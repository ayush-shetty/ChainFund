    ...
    <div>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="flex-1">
          ...
          placeholder="ETH 0.1"
             step="0.01"
               className="w-full py-[10px] sm:px-[20px] px-[15px] pb-[20px] outline-none border-[1px] border-[#3a3a43] bg-transparent font-epilogue text-white text-[18px] leading-[30px] placeholder:text-[#4b5264] rounded-[10px]"
             value={amount}
